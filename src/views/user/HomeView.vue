      ...
      >
        ...
        <div class="flex flex-col items-center gap-8 lg:flex-row lg:gap-16">
          <ul class="flex justify-center gap-2 md:gap-3 md:py-0">
            <li v-for="(item, key) in timer" :key="`${key}-${item}`">
          ...
          <RouterLink
            class="btn md:btn-lg border border-primary-50 hover:bg-primary-50 hover:text-orange-700
              focus:bg-primary-50 focus:text-orange-700 active:bg-primary-50 active:text-orange-700
              md:text-xl"
            to="/products"
            >去購物</RouterLink
          >
