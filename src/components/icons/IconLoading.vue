<template>
  <svg aria-hidden="true" :class="sizeClass"  class="inline w-4 h-4 text-stone-200 animate-spin fill-primary-800 me-1" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
